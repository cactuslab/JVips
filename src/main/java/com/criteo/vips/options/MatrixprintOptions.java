...
/**
 * Optional arguments for the "matrixprint" operation.
 */
public class MatrixprintOptions {
	 ...
	 */
	public MatrixprintOptions keep(com.criteo.vips.enums.VipsForeignKeep keep) {
		setKeep(keep);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MatrixprintOptions background(double[] background) {
	 ...
	 * @return this object for chaining
	 */
	public MatrixprintOptions backgroundPixelPacket(com.criteo.vips.PixelPacket background) {
	 ...
	 * @return this object for chaining
	 */
	public MatrixprintOptions background(java.awt.Color background) {
		setBackground(background);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MatrixprintOptions pageHeight(Integer pageHeight) {
	 ...
	 * @return this object for chaining
	 */
	public MatrixprintOptions profile(String profile) {
		setProfile(profile);
		return this;
	}
