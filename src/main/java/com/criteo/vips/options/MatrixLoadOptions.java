...
/**
 * Optional arguments for the "matrixload" operation.
 */
public class MatrixLoadOptions {
	 ...
	 */
	public MatrixLoadOptions memory(Boolean memory) {
		setMemory(memory);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MatrixLoadOptions access(com.criteo.vips.enums.VipsAccess access) {
		setAccess(access);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MatrixLoadOptions failOn(com.criteo.vips.enums.VipsFailOn failOn) {
		setFailOn(failOn);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MatrixLoadOptions revalidate(Boolean revalidate) {
