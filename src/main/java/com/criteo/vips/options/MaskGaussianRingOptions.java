...
/**
 * Optional arguments for the "mask_gaussian_ring" operation.
 */
public class MaskGaussianRingOptions {
	 ...
	 */
	public MaskGaussianRingOptions uchar(Boolean uchar) {
		setUchar(uchar);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskGaussianRingOptions nodc(Boolean nodc) {
		setNodc(nodc);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskGaussianRingOptions reject(Boolean reject) {
		setReject(reject);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskGaussianRingOptions optical(Boolean optical) {
		setOptical(optical);
		return this;
	}
