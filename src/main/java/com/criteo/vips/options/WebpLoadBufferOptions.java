...
/**
 * Optional arguments for the "webpload_buffer" operation.
 */
public class WebpLoadBufferOptions {
	 ...
	 */
	public WebpLoadBufferOptions page(Integer page) {
		setPage(page);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public WebpLoadBufferOptions n(Integer n) {
		setN(n);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public WebpLoadBufferOptions scale(Double scale) {
		setScale(scale);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public WebpLoadBufferOptions memory(Boolean memory) {
		setMemory(memory);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public WebpLoadBufferOptions access(com.criteo.vips.enums.VipsAccess access) {
		setAccess(access);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public WebpLoadBufferOptions failOn(com.criteo.vips.enums.VipsFailOn failOn) {
		setFailOn(failOn);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public WebpLoadBufferOptions revalidate(Boolean revalidate) {
