...
public class DZSaveBufferOptions {
	 ...
	 */
	public DZSaveBufferOptions imagename(String imagename) {
	 ...
	 * @return this object for chaining
	 */
	public DZSaveBufferOptions q(Integer q) {
		setQ(q);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public DZSaveBufferOptions keep(com.criteo.vips.enums.VipsForeignKeep keep) {
		setKeep(keep);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public DZSaveBufferOptions profile(String profile) {
		setProfile(profile);
		return this;
	}
