...
public class HEIFSaveOptions {
	 ...
	 * @return this object for chaining
	 */
	public HEIFSaveOptions compression(VipsForeignHeifCompression compression) {
	 ...
	 * @return this object for chaining
	 */
	public HEIFSaveOptions subsampleMode(VipsForeignSubsample subsampleMode) {
	 ...
	 * @return this object for chaining
	 */
	public HEIFSaveOptions backgroundPixelPacket(PixelPacket background) {
