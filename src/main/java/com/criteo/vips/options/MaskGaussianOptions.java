...
/**
 * Optional arguments for the "mask_gaussian" operation.
 */
public class MaskGaussianOptions {
	 ...
	 */
	public MaskGaussianOptions uchar(Boolean uchar) {
		setUchar(uchar);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskGaussianOptions nodc(Boolean nodc) {
		setNodc(nodc);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskGaussianOptions reject(Boolean reject) {
		setReject(reject);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskGaussianOptions optical(Boolean optical) {
		setOptical(optical);
		return this;
	}
