...
public class DZSaveOptions {
	 ...
	 * @return this object for chaining
	 */
	public DZSaveOptions layout(VipsForeignDzLayout layout) {
		setLayout(layout);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public DZSaveOptions depth(VipsForeignDzDepth depth) {
		setDepth(depth);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public DZSaveOptions angle(VipsAngle angle) {
		setAngle(angle);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public DZSaveOptions regionShrink(VipsRegionShrink regionShrink) {
	 ...
	 * @return this object for chaining
	 */
	public DZSaveOptions backgroundPixelPacket(PixelPacket background) {
