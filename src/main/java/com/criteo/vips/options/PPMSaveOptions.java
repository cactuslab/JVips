...
public class PPMSaveOptions {
	 ...
	 * @return this object for chaining
	 */
	public PPMSaveOptions keep(com.criteo.vips.enums.VipsForeignKeep keep) {
		setKeep(keep);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public PPMSaveOptions background(java.awt.Color background) {
		setBackground(background);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public PPMSaveOptions profile(String profile) {
		setProfile(profile);
		return this;
	}
