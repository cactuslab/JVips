...
/**
 * Optional arguments for the "radsave_buffer" operation.
 */
public class RadSaveBufferOptions {
	 ...
	 */
	public RadSaveBufferOptions keep(com.criteo.vips.enums.VipsForeignKeep keep) {
		setKeep(keep);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public RadSaveBufferOptions background(double[] background) {
	 ...
	 * @return this object for chaining
	 */
	public RadSaveBufferOptions backgroundPixelPacket(com.criteo.vips.PixelPacket background) {
	 ...
	 * @return this object for chaining
	 */
	public RadSaveBufferOptions background(java.awt.Color background) {
		setBackground(background);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public RadSaveBufferOptions pageHeight(Integer pageHeight) {
	 ...
	 * @return this object for chaining
	 */
	public RadSaveBufferOptions profile(String profile) {
		setProfile(profile);
		return this;
	}
