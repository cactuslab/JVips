...
/**
 * Optional arguments for the "mask_butterworth_band" operation.
 */
public class MaskButterworthBandOptions {
	 ...
	 */
	public MaskButterworthBandOptions uchar(Boolean uchar) {
		setUchar(uchar);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskButterworthBandOptions nodc(Boolean nodc) {
		setNodc(nodc);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskButterworthBandOptions reject(Boolean reject) {
		setReject(reject);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskButterworthBandOptions optical(Boolean optical) {
		setOptical(optical);
		return this;
	}
