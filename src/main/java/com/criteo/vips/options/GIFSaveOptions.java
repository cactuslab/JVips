...
public class GIFSaveOptions {
	 ...
	 * @return this object for chaining
	 */
	public GIFSaveOptions keepDuplicateFrames(Boolean keepDuplicateFrames) {
	 ...
	 * @return this object for chaining
	 */
	public GIFSaveOptions keep(com.criteo.vips.enums.VipsForeignKeep keep) {
		setKeep(keep);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public GIFSaveOptions profile(String profile) {
		setProfile(profile);
		return this;
	}
