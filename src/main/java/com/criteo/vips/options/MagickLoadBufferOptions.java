 ...
 */
public class MagickLoadBufferOptions {
	 ...
	 */
	public MagickLoadBufferOptions density(String density) {
		setDensity(density);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MagickLoadBufferOptions page(Integer page) {
		setPage(page);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MagickLoadBufferOptions n(Integer n) {
		setN(n);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MagickLoadBufferOptions memory(Boolean memory) {
		setMemory(memory);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MagickLoadBufferOptions revalidate(Boolean revalidate) {
