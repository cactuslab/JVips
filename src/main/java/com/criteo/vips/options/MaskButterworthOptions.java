...
/**
 * Optional arguments for the "mask_butterworth" operation.
 */
public class MaskButterworthOptions {
	 ...
	 */
	public MaskButterworthOptions uchar(Boolean uchar) {
		setUchar(uchar);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskButterworthOptions nodc(Boolean nodc) {
		setNodc(nodc);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskButterworthOptions reject(Boolean reject) {
		setReject(reject);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskButterworthOptions optical(Boolean optical) {
		setOptical(optical);
		return this;
	}
