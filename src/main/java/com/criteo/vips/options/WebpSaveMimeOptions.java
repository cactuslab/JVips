...
public class WebpSaveMimeOptions {
	 ...
	 * @return this object for chaining
	 */
	public WebpSaveMimeOptions targetSize(Integer targetSize) {
	 ...
	 * @return this object for chaining
	 */
	public WebpSaveMimeOptions smartDeblock(Boolean smartDeblock) {
	 ...
	 * @return this object for chaining
	 */
	public WebpSaveMimeOptions passes(Integer passes) {
		setPasses(passes);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public WebpSaveMimeOptions keep(com.criteo.vips.enums.VipsForeignKeep keep) {
		setKeep(keep);
		return this;
	}
