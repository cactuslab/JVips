...
/**
 * Optional arguments for the "tiffsave_buffer" operation.
 */
public class TIFFSaveBufferOptions {
	 ...
	 */
	public TIFFSaveBufferOptions compression(com.criteo.vips.enums.VipsForeignTiffCompression compression) {
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions q(Integer q) {
		setQ(q);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions predictor(com.criteo.vips.enums.VipsForeignTiffPredictor predictor) {
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions tile(Boolean tile) {
		setTile(tile);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions tileWidth(Integer tileWidth) {
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions tileHeight(Integer tileHeight) {
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions pyramid(Boolean pyramid) {
		setPyramid(pyramid);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions miniswhite(Boolean miniswhite) {
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions bitdepth(Integer bitdepth) {
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions resunit(com.criteo.vips.enums.VipsForeignTiffResunit resunit) {
		setResunit(resunit);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions xres(Double xres) {
		setXres(xres);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions yres(Double yres) {
		setYres(yres);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions bigtiff(Boolean bigtiff) {
		setBigtiff(bigtiff);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions properties(Boolean properties) {
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions regionShrink(com.criteo.vips.enums.VipsRegionShrink regionShrink) {
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions level(Integer level) {
		setLevel(level);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions lossless(Boolean lossless) {
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions depth(com.criteo.vips.enums.VipsForeignDzDepth depth) {
		setDepth(depth);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions subifd(Boolean subifd) {
		setSubifd(subifd);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions premultiply(Boolean premultiply) {
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions keep(com.criteo.vips.enums.VipsForeignKeep keep) {
		setKeep(keep);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions background(double[] background) {
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions backgroundPixelPacket(com.criteo.vips.PixelPacket background) {
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions background(java.awt.Color background) {
		setBackground(background);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions pageHeight(Integer pageHeight) {
	 ...
	 * @return this object for chaining
	 */
	public TIFFSaveBufferOptions profile(String profile) {
		setProfile(profile);
		return this;
	}
