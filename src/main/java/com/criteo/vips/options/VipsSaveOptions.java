...
/**
 * Optional arguments for the "vipssave" operation.
 */
public class VipsSaveOptions {
	 ...
	 */
	public VipsSaveOptions keep(com.criteo.vips.enums.VipsForeignKeep keep) {
		setKeep(keep);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public VipsSaveOptions background(double[] background) {
	 ...
	 * @return this object for chaining
	 */
	public VipsSaveOptions backgroundPixelPacket(com.criteo.vips.PixelPacket background) {
	 ...
	 * @return this object for chaining
	 */
	public VipsSaveOptions background(java.awt.Color background) {
		setBackground(background);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public VipsSaveOptions pageHeight(Integer pageHeight) {
	 ...
	 * @return this object for chaining
	 */
	public VipsSaveOptions profile(String profile) {
		setProfile(profile);
		return this;
	}
