...
/**
 * Optional arguments for the "ppmload_buffer" operation.
 */
public class PPMLoadBufferOptions {
	 ...
	 */
	public PPMLoadBufferOptions memory(Boolean memory) {
		setMemory(memory);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public PPMLoadBufferOptions access(com.criteo.vips.enums.VipsAccess access) {
		setAccess(access);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public PPMLoadBufferOptions failOn(com.criteo.vips.enums.VipsFailOn failOn) {
		setFailOn(failOn);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public PPMLoadBufferOptions revalidate(Boolean revalidate) {
