...
/**
 * Optional arguments for the "webpload" operation.
 */
public class WebpLoadOptions {
	 ...
	 */
	public WebpLoadOptions page(Integer page) {
		setPage(page);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public WebpLoadOptions n(Integer n) {
		setN(n);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public WebpLoadOptions scale(Double scale) {
		setScale(scale);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public WebpLoadOptions memory(Boolean memory) {
		setMemory(memory);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public WebpLoadOptions access(com.criteo.vips.enums.VipsAccess access) {
		setAccess(access);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public WebpLoadOptions failOn(com.criteo.vips.enums.VipsFailOn failOn) {
		setFailOn(failOn);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public WebpLoadOptions revalidate(Boolean revalidate) {
