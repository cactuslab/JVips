...
public class XYZ2LabOptions {
	 ...
	 */
	public XYZ2LabOptions temp(double[] temp) {
		setTemp(temp);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public XYZ2LabOptions tempPixelPacket(com.criteo.vips.PixelPacket temp) {
	 ...
	 * @return this object for chaining
	 */
	public XYZ2LabOptions temp(java.awt.Color temp) {
		setTemp(temp);
		return this;
	}
