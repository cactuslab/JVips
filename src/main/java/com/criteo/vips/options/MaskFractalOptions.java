...
/**
 * Optional arguments for the "mask_fractal" operation.
 */
public class MaskFractalOptions {
	 ...
	 */
	public MaskFractalOptions uchar(Boolean uchar) {
		setUchar(uchar);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskFractalOptions nodc(Boolean nodc) {
		setNodc(nodc);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskFractalOptions reject(Boolean reject) {
		setReject(reject);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskFractalOptions optical(Boolean optical) {
		setOptical(optical);
		return this;
	}
