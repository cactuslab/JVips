...
/**
 * Optional arguments for the "analyzeload" operation.
 */
public class AnalyzeLoadOptions {
	 ...
	 */
	public AnalyzeLoadOptions memory(Boolean memory) {
		setMemory(memory);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public AnalyzeLoadOptions access(com.criteo.vips.enums.VipsAccess access) {
		setAccess(access);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public AnalyzeLoadOptions failOn(com.criteo.vips.enums.VipsFailOn failOn) {
		setFailOn(failOn);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public AnalyzeLoadOptions revalidate(Boolean revalidate) {
