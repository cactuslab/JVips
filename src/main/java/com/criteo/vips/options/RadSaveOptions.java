...
/**
 * Optional arguments for the "radsave" operation.
 */
public class RadSaveOptions {
	 ...
	 * @return this object for chaining
	 */
	public RadSaveOptions background(double[] background) {
	 ...
	 * @return this object for chaining
	 */
	public RadSaveOptions backgroundPixelPacket(com.criteo.vips.PixelPacket background) {
	 ...
	 * @return this object for chaining
	 */
	public RadSaveOptions background(java.awt.Color background) {
		setBackground(background);
		return this;
	}
