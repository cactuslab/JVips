...
/**
 * Optional arguments for the "mask_gaussian_band" operation.
 */
public class MaskGaussianBandOptions {
	 ...
	 */
	public MaskGaussianBandOptions uchar(Boolean uchar) {
		setUchar(uchar);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskGaussianBandOptions nodc(Boolean nodc) {
		setNodc(nodc);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskGaussianBandOptions reject(Boolean reject) {
		setReject(reject);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskGaussianBandOptions optical(Boolean optical) {
		setOptical(optical);
		return this;
	}
