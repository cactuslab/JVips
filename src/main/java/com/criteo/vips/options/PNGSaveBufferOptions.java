...
public class PNGSaveBufferOptions {
	 ...
	 * @return this object for chaining
	 */
	public PNGSaveBufferOptions filter(VipsForeignPngFilter filter) {
		setFilter(filter);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public PNGSaveBufferOptions strip(Boolean strip) {
		setStrip(strip);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public PNGSaveBufferOptions backgroundPixelPacket(PixelPacket background) {
