...
/**
 * Optional arguments for the "mask_ideal_band" operation.
 */
public class MaskIdealBandOptions {
	 ...
	 */
	public MaskIdealBandOptions uchar(Boolean uchar) {
		setUchar(uchar);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskIdealBandOptions nodc(Boolean nodc) {
		setNodc(nodc);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskIdealBandOptions reject(Boolean reject) {
		setReject(reject);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskIdealBandOptions optical(Boolean optical) {
		setOptical(optical);
		return this;
	}
