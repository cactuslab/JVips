 ...
 */
public class GIFLoadBufferOptions {
	 ...
	 */
	public GIFLoadBufferOptions n(Integer n) {
		setN(n);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public GIFLoadBufferOptions page(Integer page) {
		setPage(page);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public GIFLoadBufferOptions memory(Boolean memory) {
		setMemory(memory);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public GIFLoadBufferOptions revalidate(Boolean revalidate) {
