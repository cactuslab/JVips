...
public class PDFLoadBufferOptions {
	 ...
	 * @return this object for chaining
	 */
	public PDFLoadBufferOptions backgroundPixelPacket(com.criteo.vips.PixelPacket background) {
	 ...
	 * @return this object for chaining
	 */
	public PDFLoadBufferOptions access(com.criteo.vips.enums.VipsAccess access) {
		setAccess(access);
		return this;
	}
