...
public class JPEGSaveBufferOptions {
	 ...
	 * @return this object for chaining
	 */
	public JPEGSaveBufferOptions subsampleMode(com.criteo.vips.enums.VipsForeignSubsample subsampleMode) {
	 ...
	 * @return this object for chaining
	 */
	public JPEGSaveBufferOptions keep(com.criteo.vips.enums.VipsForeignKeep keep) {
		setKeep(keep);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public JPEGSaveBufferOptions background(double[] background) {
	 ...
	 * @return this object for chaining
	 */
	public JPEGSaveBufferOptions backgroundPixelPacket(com.criteo.vips.PixelPacket background) {
	 ...
	 * @return this object for chaining
	 */
	public JPEGSaveBufferOptions background(java.awt.Color background) {
		setBackground(background);
		return this;
	}
