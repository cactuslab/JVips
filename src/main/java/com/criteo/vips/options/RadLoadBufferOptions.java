...
/**
 * Optional arguments for the "radload_buffer" operation.
 */
public class RadLoadBufferOptions {
	 ...
	 */
	public RadLoadBufferOptions memory(Boolean memory) {
		setMemory(memory);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public RadLoadBufferOptions access(com.criteo.vips.enums.VipsAccess access) {
		setAccess(access);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public RadLoadBufferOptions failOn(com.criteo.vips.enums.VipsFailOn failOn) {
		setFailOn(failOn);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public RadLoadBufferOptions revalidate(Boolean revalidate) {
