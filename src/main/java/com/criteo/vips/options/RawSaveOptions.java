...
/**
 * Optional arguments for the "rawsave" operation.
 */
public class RawSaveOptions {
	 ...
	 */
	public RawSaveOptions keep(com.criteo.vips.enums.VipsForeignKeep keep) {
		setKeep(keep);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public RawSaveOptions background(double[] background) {
	 ...
	 * @return this object for chaining
	 */
	public RawSaveOptions backgroundPixelPacket(com.criteo.vips.PixelPacket background) {
	 ...
	 * @return this object for chaining
	 */
	public RawSaveOptions background(java.awt.Color background) {
		setBackground(background);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public RawSaveOptions pageHeight(Integer pageHeight) {
	 ...
	 * @return this object for chaining
	 */
	public RawSaveOptions profile(String profile) {
		setProfile(profile);
		return this;
	}
