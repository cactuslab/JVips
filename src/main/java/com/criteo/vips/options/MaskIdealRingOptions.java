...
/**
 * Optional arguments for the "mask_ideal_ring" operation.
 */
public class MaskIdealRingOptions {
	 ...
	 */
	public MaskIdealRingOptions uchar(Boolean uchar) {
		setUchar(uchar);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskIdealRingOptions nodc(Boolean nodc) {
		setNodc(nodc);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskIdealRingOptions reject(Boolean reject) {
		setReject(reject);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskIdealRingOptions optical(Boolean optical) {
		setOptical(optical);
		return this;
	}
