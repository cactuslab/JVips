...
/**
 * Optional arguments for the "tiffload" operation.
 */
public class TIFFLoadOptions {
	 ...
	 */
	public TIFFLoadOptions page(Integer page) {
		setPage(page);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public TIFFLoadOptions n(Integer n) {
		setN(n);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public TIFFLoadOptions autorotate(Boolean autorotate) {
	 ...
	 * @return this object for chaining
	 */
	public TIFFLoadOptions subifd(Integer subifd) {
		setSubifd(subifd);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public TIFFLoadOptions unlimited(Boolean unlimited) {
	 ...
	 * @return this object for chaining
	 */
	public TIFFLoadOptions memory(Boolean memory) {
		setMemory(memory);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public TIFFLoadOptions access(com.criteo.vips.enums.VipsAccess access) {
		setAccess(access);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public TIFFLoadOptions failOn(com.criteo.vips.enums.VipsFailOn failOn) {
		setFailOn(failOn);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public TIFFLoadOptions revalidate(Boolean revalidate) {
