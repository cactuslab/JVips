...
/**
 * Optional arguments for the "matrixsave" operation.
 */
public class MatrixSaveOptions {
	 ...
	 */
	public MatrixSaveOptions keep(com.criteo.vips.enums.VipsForeignKeep keep) {
		setKeep(keep);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MatrixSaveOptions background(double[] background) {
	 ...
	 * @return this object for chaining
	 */
	public MatrixSaveOptions backgroundPixelPacket(com.criteo.vips.PixelPacket background) {
	 ...
	 * @return this object for chaining
	 */
	public MatrixSaveOptions background(java.awt.Color background) {
		setBackground(background);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MatrixSaveOptions pageHeight(Integer pageHeight) {
	 ...
	 * @return this object for chaining
	 */
	public MatrixSaveOptions profile(String profile) {
		setProfile(profile);
		return this;
	}
