...
public class WebpSaveBufferOptions {
	 ...
	 * @return this object for chaining
	 */
	public WebpSaveBufferOptions targetSize(Integer targetSize) {
	 ...
	 * @return this object for chaining
	 */
	public WebpSaveBufferOptions smartDeblock(Boolean smartDeblock) {
	 ...
	 * @return this object for chaining
	 */
	public WebpSaveBufferOptions passes(Integer passes) {
		setPasses(passes);
		return this;
	}
