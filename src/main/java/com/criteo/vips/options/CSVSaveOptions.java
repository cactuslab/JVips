...
public class CSVSaveOptions {
	 ...
	 */
	public CSVSaveOptions separator(String separator) {
	 ...
	 * @return this object for chaining
	 */
	public CSVSaveOptions keep(com.criteo.vips.enums.VipsForeignKeep keep) {
		setKeep(keep);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public CSVSaveOptions backgroundPixelPacket(com.criteo.vips.PixelPacket background) {
	 ...
	 * @return this object for chaining
	 */
	public CSVSaveOptions background(java.awt.Color background) {
		setBackground(background);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public CSVSaveOptions pageHeight(Integer pageHeight) {
	 ...
	 * @return this object for chaining
	 */
	public CSVSaveOptions profile(String profile) {
		setProfile(profile);
		return this;
	}
