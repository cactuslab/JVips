...
public class RawSaveFdOptions {
	 ...
	 */
	public RawSaveFdOptions keep(com.criteo.vips.enums.VipsForeignKeep keep) {
		setKeep(keep);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public RawSaveFdOptions background(double[] background) {
	 ...
	 * @return this object for chaining
	 */
	public RawSaveFdOptions background(java.awt.Color background) {
		setBackground(background);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public RawSaveFdOptions pageHeight(Integer pageHeight) {
	 ...
	 * @return this object for chaining
	 */
	public RawSaveFdOptions profile(String profile) {
		setProfile(profile);
		return this;
	}
