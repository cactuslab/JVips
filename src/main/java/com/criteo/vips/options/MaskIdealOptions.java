...
/**
 * Optional arguments for the "mask_ideal" operation.
 */
public class MaskIdealOptions {
	 ...
	 */
	public MaskIdealOptions uchar(Boolean uchar) {
		setUchar(uchar);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskIdealOptions nodc(Boolean nodc) {
		setNodc(nodc);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskIdealOptions reject(Boolean reject) {
		setReject(reject);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public MaskIdealOptions optical(Boolean optical) {
		setOptical(optical);
		return this;
	}
