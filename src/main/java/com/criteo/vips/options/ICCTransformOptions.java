...
public class ICCTransformOptions {
	 ...
	 * @return this object for chaining
	 */
	public ICCTransformOptions blackPointCompensation(Boolean blackPointCompensation) {
	 ...
	 * @return this object for chaining
	 */
	public ICCTransformOptions embedded(Boolean embedded) {
	 ...
	 * @return this object for chaining
	 */
	public ICCTransformOptions inputProfile(String inputProfile) {
	 ...
	 * @return this object for chaining
	 */
	public ICCTransformOptions depth(Integer depth) {
		setDepth(depth);
		return this;
	}
