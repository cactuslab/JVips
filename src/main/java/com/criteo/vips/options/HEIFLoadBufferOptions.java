...
/**
 * Optional arguments for the "heifload_buffer" operation.
 */
public class HEIFLoadBufferOptions {
	 ...
	 */
	public HEIFLoadBufferOptions page(Integer page) {
		setPage(page);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public HEIFLoadBufferOptions n(Integer n) {
		setN(n);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public HEIFLoadBufferOptions thumbnail(Boolean thumbnail) {
	 ...
	 * @return this object for chaining
	 */
	public HEIFLoadBufferOptions unlimited(Boolean unlimited) {
	 ...
	 * @return this object for chaining
	 */
	public HEIFLoadBufferOptions memory(Boolean memory) {
		setMemory(memory);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public HEIFLoadBufferOptions access(com.criteo.vips.enums.VipsAccess access) {
		setAccess(access);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public HEIFLoadBufferOptions failOn(com.criteo.vips.enums.VipsFailOn failOn) {
		setFailOn(failOn);
		return this;
	}
	 ...
	 * @return this object for chaining
	 */
	public HEIFLoadBufferOptions revalidate(Boolean revalidate) {
